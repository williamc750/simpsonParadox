...
**🎯 Your Task:** Use Cursor’s AI assistant to create a compelling
side-by-side comparison plot!

**Instructions:** 1. Ask Cursor: *“Create a side-by-side comparison plot
using patchwork that combines plot1 and plot2 with a title, subtitle,
and caption explaining Simpson’s Paradox”* 2. The plot should clearly
show the contrast between the overall relationship and the
species-specific relationships 3. Use `theme_minimal(16)` for
consistency 4. **Replace these instructions with the actual plot code
that Cursor generates** 5. **Render the README.md file** using
`quarto render README.qmd` 6. Make sure to sync your changes to your
GitHub folder for grading!
